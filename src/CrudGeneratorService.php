...
print_r($options);
        ...
        $filegenerator->Generate();
        $filegenerator->templateName = 'HistoryRequest';
        $filegenerator->path = app_path() . "/Http/Requests/$modelname/${modelname}HistoryRequest.php";
        $filegenerator->Generate();
        $filegenerator->templateName = 'HistoryDifferenceRequest';
        $filegenerator->path = app_path() . "/Http/Requests/$modelname/${modelname}HistoryDifferenceRequest.php";
        $filegenerator->Generate();
        $filegenerator->templateName = 'IndexRequest';
        $filegenerator->path = app_path() . "/Http/Requests/$modelname/${modelname}IndexRequest.php";
        $filegenerator->Generate();
